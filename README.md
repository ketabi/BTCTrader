...
- 🎯 Entry points to execute your program using `python -m <btctrader>` or `$ btctrader` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/ketabi/BTCTrader/branch/main/graph/badge.svg?token=BTCTrader_token_here)](https://codecov.io/gh/ketabi/BTCTrader)
[![CI](https://github.com/ketabi/BTCTrader/actions/workflows/main.yml/badge.svg)](https://github.com/ketabi/BTCTrader/actions/workflows/main.yml)

Awesome btctrader created by ketabi

## Install

from source
```bash
git clone https://github.com/ketabi/BTCTrader btctrader
cd btctrader
make install
```
...
```bash
pip install btctrader
```

## Executing

```bash
$ btctrader run --port 8080
```

or

```bash
python -m btctrader run --port 8080
```

or

```bash
$ uvicorn btctrader:app
```
...
```bash
❯ btctrader --help
Usage: btctrader [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ btctrader create-user --help
Usage: btctrader create-user [OPTIONS] USERNAME PASSWORD
...
```bash
btctrader create-user admin admin --superuser
```
...
Run with `btctrader run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `btctrader create-user`.
...
-----------------------------------------------------
btctrader/__init__.py              4      0   100%
btctrader/app.py                  16      1    94%
btctrader/cli.py                  21      0   100%
btctrader/config.py                5      0   100%
btctrader/db.py                   10      0   100%
btctrader/models/__init__.py       0      0   100%
btctrader/models/content.py       47      1    98%
btctrader/routes/__init__.py      11      0   100%
btctrader/routes/content.py       52     25    52%
btctrader/routes/security.py      15      1    93%
btctrader/routes/user.py          52     26    50%
btctrader/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in btctrader/default.toml.
